...
void MDIO_voidSetPinValue(u8 Copy_u8Port, u8 Copy_u8Pin, u8 Copy_u8PinVal){
	if(Copy_u8PinVal == DIO_U8_HIGH)
	{
		switch(Copy_u8Port)
		{
			case MDIO_PORTA:	MDIO_GPIOA->ODR=Set_Bit(MDIO_GPIOA->ODR, Copy_u8Pin);	break;
			case MDIO_PORTB:	MDIO_GPIOB->ODR=Set_Bit(MDIO_GPIOB->ODR, Copy_u8Pin);	break;
			case MDIO_PORTC:	MDIO_GPIOC->ODR=Set_Bit(MDIO_GPIOC->ODR, Copy_u8Pin);	break;
	...
	else if(Copy_u8PinVal == DIO_U8_LOW)
	{
		switch(Copy_u8Port)
		{
			case MDIO_PORTA:	MDIO_GPIOA->ODR=Clr_Bit(MDIO_GPIOA->ODR, Copy_u8Pin);	break;
			case MDIO_PORTB:	MDIO_GPIOB->ODR=Clr_Bit(MDIO_GPIOB->ODR, Copy_u8Pin);	break;
			case MDIO_PORTC:	MDIO_GPIOC->ODR=Clr_Bit(MDIO_GPIOC->ODR, Copy_u8Pin);	break;
			default: /* Report Error */ 										break;
		}
	}
}
